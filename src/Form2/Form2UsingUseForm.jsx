      ...
      <form action="" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <input
            type="password"
            name="password"
            {...register("password", { required: "Password is Required", minLength: {value:6, message: "Password must be of 6 characters"} })}
          />
        ...
        <div>
          ...
          <input
            ...
            {...register("confirmPassword", { required: "Confirm Password is Required", validate: value => value === password || "Password did not match"})}
          />
          <div>{errors.confirmPassword && <span>{errors.confirmPassword.message}</span>}</div>
        </div>
        <div>
